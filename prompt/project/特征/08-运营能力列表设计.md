...
| `debt_subsidy_300` | 欠账300加欠款补贴 | 闪电龟 | `{ "debt": { "enabled": true, "debtFloor": -300, "forbidEquipWhenDebt": true, "errorCode": "DEBT_UNPAID" }, "debt_subsidy": { "enabled": true, "subsidyRate": 0.25 } }` |
| `debt_subsidy_1000` | 欠账1000加欠款补贴 | 龟壳 | `{ "debt": { "enabled": true, "debtFloor": -1000, "forbidEquipWhenDebt": true, "errorCode": "DEBT_UNPAID" }, "debt_subsidy": { "enabled": true, "subsidyRate": 0.22 } }` |
